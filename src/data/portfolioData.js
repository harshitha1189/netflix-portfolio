...
experience: [
  {
    ...
    type: "Internship",
    achievements: [
     "Built and optimized reusable UI components in React Native, improving development speed and ensuring design consistency across the app",
...
skills: [
  ...
  { name: "JavaScript", icon: "https://skillicons.dev/icons?i=javascript", level: 90 },
  { name: "Python", icon: "https://skillicons.dev/icons?i=python", level: 75 },
  ...
  { name: "Next.js", icon: "https://skillicons.dev/icons?i=nextjs", level: 85 },
  { name: "Node.js", icon: "https://skillicons.dev/icons?i=nodejs", level: 80 },
  { name: "Express.js", icon: "https://skillicons.dev/icons?i=express", level: 85 },
  { name: "Django", icon: "https://skillicons.dev/icons?i=django", level: 70 },
